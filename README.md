...
Actualmente, el repositorio cuenta con los siguientes archivos correspondientes a las tareas asignadas:

* 📄 `tarea_4_figuras_geometricas.psc` - Algoritmo enfocado en el cálculo y lógica de figuras geométricas en PSeInt.
* 📄 `tarea_4_ventas_con_descuento.psc` - Algoritmo diseñado para el cálculo de ventas y aplicaciones de descuentos en PSeInt.

*Gracias por su tiempo y revisión.*